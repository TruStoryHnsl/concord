...
# dev stack: ``CONDUWUIT_SERVER_NAME=192.0.2.10`` was inherited from
# the original LAN-only bootstrap, then surfaced as
# ``livekit_url=wss://192.0.2.10/livekit/`` in the discovery doc.
...
async def test_lan_ip_server_name_drops_livekit_url(client, monkeypatch):
    ...
    monkeypatch.setenv("CONDUWUIT_SERVER_NAME", "192.0.2.10")
