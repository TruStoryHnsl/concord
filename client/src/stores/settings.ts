...
interface SettingsState {
  ...
  settingsTab: "audio" | "voice" | "notifications" | "profile" | "users" | "connections" | "appearance" | "node" | "hosting" | "connectors" | "about" | "admin" | "server-general" | "server-members" | "server-invite" | "server-bans" | "server-whitelist" | "server-webhooks" | "server-moderation" | "server-federation";
