...
export function SourcesPanel({
  ...
  // Primary click on a source tile opens (navigates into) that source —
  // it does NOT toggle the source on/off. Toggling visibility is a rare
  // action and lives in the right-click menu. Clicking always reveals the
  // source first so a click can never hide the server you're trying to reach.
