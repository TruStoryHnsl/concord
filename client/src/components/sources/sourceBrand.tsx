...
export function SourceBrandIcon({
  ...
  if (brand === "matrix") {
    return (
      <svg
        ...
        aria-hidden="true"
      >
        <rect x="2.5" y="2.5" width="19" height="19" rx="4.5" fill="#111318" />
        <path
  ...
  if (brand === "mozilla") {
    return (
      ...
      >
        <defs>
          <linearGradient id="mozilla-gradient" x1="4" y1="4" x2="20" y2="20">
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="2.5" y="2.5" width="19" height="19" rx="4.5" fill="#5865F2" />
      <path
