 ...
 *   1. ChatLayout is the first interactive surface.
 *   2. ServerPickerScreen is NOT rendered.
 *   3. LoginForm is NOT rendered.
 *
...
describe("native first launch — drops straight into ChatLayout", () => {
  ...
  it("renders ChatLayout immediately — no LoginForm, no picker", async () => {
