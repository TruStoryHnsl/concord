...
# ── Concorrd Install Wizard ─────────────────────────────────────────────
# Interactive installer for Concorrd — a Discord replacement on Matrix.
...
banner() {
  echo ""
  echo -e "${CYAN}${BOLD}╔══════════════════════════════════════════╗${NC}"
  echo -e "${CYAN}${BOLD}║         Concorrd Install Wizard          ║${NC}"
...
echo -e "${DIM}Examples: concorrd.example.com, 192.168.1.50, localhost${NC}"
...
step "Building and starting Concorrd"
...
echo -e "${GREEN}${BOLD}║       Concorrd is ready!                 ║${NC}"
echo -e "${GREEN}${BOLD}╚══════════════════════════════════════════╝${NC}"
echo ""
